...
# Assuming df and df2 are already defined above
ex_data = df.copy()
market_cap = df2.copy()
...
# Now, the plot will not show unless you explicitly call the function and then call .show() on the returned figure
fig = create_plots()
# fig.show() # Uncomment this line when you want to display the plot
```
